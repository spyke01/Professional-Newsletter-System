...
function ajaxShowNewsletterPreview(contentID, holderID) {
	new Ajax.Updater(holderID, 'ajax.php?action=showNewsletterPreview&content=' + tinyMCE.get(contentID).getContent(), {asynchronous:true, evalScripts:true});
}